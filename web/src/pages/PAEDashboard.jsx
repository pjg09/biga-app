  ...
  return (
    <>
        ...
        <div className="dash__modal-overlay" onClick={() => !confirming && setSelected(null)}>
          <div className="dash__modal" onClick={e => e.stopPropagation()} role="dialog" aria-modal="true">
            ...
            <p className="dash__modal-warning">
              Verificá que el estudiante frente a vos coincide con la foto antes de confirmar.
            </p>
      ...
      <div className="dash__stats">
        <StatCard icon={<ListCheckIcon />} value={enrolled}  label="Matriculados PAE" fill={100}                           pae />
        <StatCard icon={<CheckIcon />}     value={delivered} label="Reclamados hoy"   fill={pct}   delta={`${pct}%`}      pae />
        <StatCard icon={<AlertIcon />}     value={pending}   label="Sin reclamar"     fill={enrolled > 0 ? pending/enrolled*100 : 0} fillClass="red" pae />
      </div>
          ...
          <form className="dash__modal dash__modal--form" onClick={e => e.stopPropagation()} onSubmit={handleCreate} role="dialog" aria-modal="true">
            ...
            <div className="dash__form-grid">
              ...
              <label className="dash__field dash__field--full">
                <span className="dash__field-label">URL de foto <span className="dash__field-optional">(opcional)</span></span>
                <input className="dash__field-input" type="url" value={form.photo_url} onChange={updateField('photo_url')}
                  maxLength={500} placeholder="https://…" autoComplete="off" />
              </label>
            </div>
